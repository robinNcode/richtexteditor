...
<head>
	...
	<script type="text/javasceipt" src="./richtexteditor/lang/rte-lang-bn.js"></script>
	<?php $lang = 'bn'; if ($lang == 'bn') : ?>
		<script type="text/javascript" src="./richtexteditor/rte-bn.js"></script>
	<?php else : ?>
		<script type="text/javascript" src="./richtexteditor/rte-en.js"></script>
	<?php endif; ?>
